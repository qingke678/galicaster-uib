...
class TestFunctions(TestCase):
    ...
    def test_element_instantiation(self):   
        ...
        try:
            mediapackage.Element(self.path_track1)
        except RuntimeError:
            pass
        else:
            raise AssertionError("The class Element should be abstract")
    ...
    def test_fromXML(self):        
        ...
        self.assertEqual(mp.notes, "Nota de Prueba <?php Caracteres ñ I'm raros >")
